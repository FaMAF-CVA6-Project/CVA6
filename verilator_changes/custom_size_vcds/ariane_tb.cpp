...
// Upstream dumps from cycle 0 to the end of the run. The purpose is a VCD of a
// long benchmark small enough to keep and convert, since an unwindowed dump of
// one of these runs reaches tens of gigabytes.
//
