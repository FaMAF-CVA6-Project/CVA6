...
| `index.html`, `.nojekyll`                                                      | The GitHub Pages entry: a redirect to FlowCompare, served as it is.                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
FlowCompare is also this repository's GitHub Pages site. `index.html` at the root sends a visitor on to `viewers/FlowCompare.html`, and `.nojekyll` has the files served as they are, so the site is published from the root of `master` with no build.
