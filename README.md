...
| `gem5_config_CVA6/CVA6/`                        | The CVA6 side of the calibration: its benchmarks, the target's configuration package, and `tests/`, where local, untracked JSONs go.                                                                                                                                                                                                                                                                                                                                                     |
| `gem5_config_CVA6/gem5/`                        | The gem5 side: its benchmarks, the configurations and the patch under `configs/`, and `tests/`, where local, untracked JSONs go.                                                                                                                                                                                                                                                                                                                                                         |
...
| `viewers/MinorFlow`                             | The MinorFlow viewer, as a submodule.                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| `viewers/CVA6Flow`                              | The CVA6Flow viewer, as a submodule.                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
