...
| [`assets/`](assets/README.md)                       | The project's mark, in the three sizes the documents use, and the palette every page and mark shares. `assets/README.md` says what the mark means and how `temp/logo/make_logos.py` redraws it.                                                                                                                                                                                                                                                                                          |
